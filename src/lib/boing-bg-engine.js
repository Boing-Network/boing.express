...
// ─── EXPRESS (boing.express) — export only ─────────────────────────────────
export { BoingBackground };
export const EXPRESS_BG_CONFIGS = BOING_BG_CONFIGS.express;

/** Minimal config when prefers-reduced-motion: no shooting stars, no ocean layers, stars + nebula only */
export const EXPRESS_REDUCED_MOTION_CONFIG = {
  baseBg: ['#020810', '#041220', '#051828'],
  accentColor: '#00e8c8',
  starCount: 60,
  starOpacityMin: 0.08,
  starOpacityMax: 0.4,
  nebulaClouds: [
    { x: 0.2, y: 0.1, r: 200, color: '#00e8c8', opacity: 0.04 },
    { x: 0.75, y: 0.12, r: 220, color: '#0096c7', opacity: 0.03 },
  ],
